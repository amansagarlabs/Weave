...
public class EditRequestService {
    ...
    public EditRequestService(EditRequestRepository requests, UserRepository users, NotificationService notifications, S3StorageService storage) { this.requests = requests; this.users = users; this.notifications = notifications; this.storage = storage; }
