  ...
  return (
    <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
      <Card className="space-y-4">
        ...
        <label className="block space-y-2">
          ...
          <input
            ...
            className="min-h-12 w-full rounded-2xl border border-[var(--line)] bg-white px-4 py-3 text-sm outline-none transition-colors placeholder:text-[var(--muted)] focus:border-[var(--forest)]"
          />
        </label>
        ...
        <label className="block space-y-2">
          ...
          <textarea
            ...
            rows={4}
            className="w-full rounded-2xl border border-[var(--line)] bg-white px-4 py-3 text-sm outline-none transition-colors placeholder:text-[var(--muted)] focus:border-[var(--forest)]"
          />
        </label>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
          <button
            ...
            className="inline-flex min-h-12 items-center justify-center rounded-full border-2 border-[var(--ink)] bg-white px-5 py-3 text-sm font-bold transition-transform active:scale-[.97]"
          >
            Reset draft
          </button>
          <button
      ...
      <Card className="space-y-4 border border-[var(--line)] bg-[var(--paper)]">
        ...
        <div className="rounded-[24px] bg-white p-5 shadow-[0_8px_24px_rgba(23,34,31,.06)]">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {categoryCopy.map((category) => (
            <div key={category.label} className="rounded-2xl bg-white p-4 shadow-[0_8px_24px_rgba(23,34,31,.06)]">
